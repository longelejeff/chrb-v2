...
export function PaginationControls({
  ...
  return (
    <>
      ...
      <div className="sm:hidden flex items-center justify-between gap-3 pt-3 pb-2 border-t border-slate-200">
        <button
          onClick={() => onPageChange(currentPage - 1)}
          disabled={currentPage === 1}
          className="flex-shrink-0 px-4 py-2 bg-white border border-slate-300 rounded-lg text-sm font-medium text-slate-700 hover:bg-slate-50 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200 min-h-[44px]"
        >
          Préc.
        </button>
